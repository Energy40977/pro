                                            ...
                                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                ...
                                                @foreach($news as $new)
                                                    <tr>
                                                        ...
                                                        <td>{{$new['author']}}</td>
                                                        <td>{{$new['read']}}</td>
                                                        <td>{{$new['created_at']->translatedFormat('j F, Y H:i')}}</td>
                                                        <td class="text-right">

                                                            <a href="/control/editnews/{{$new['id']}}" id="{{$new['id']}}" class="btn btn-link btn-warning btn-just-icon edit"><i class="material-icons">dvr</i></a>
                                                            <a href="#" id="{{$new['id']}}" class="btn btn-link btn-danger btn-just-icon remove"><i class="material-icons">close</i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
