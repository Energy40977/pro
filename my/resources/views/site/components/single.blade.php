            ...
            <div class="container">
                <div class="row mb-50">
                    <div class="col-lg-8 col-md-12">
                        ...
                        @endif
                        <a class="venobox" data-gall="myGallery" data-lightbox="gallery" href="{{asset('/news/images/'.$news['image'])}}"  >
                        <figure class="single-thumnail">
                            <picture>
                                ...
                                <img src="{{asset('/news/images/'.$news['image'])}}" width="1200px;"  height="550px"  alt="{{$news['title']}}">
                            </picture>
                        </figure>
                        </a>
                        ...
                        <!--author box-->
                                        <div class="author-bio border-radius-10 bg-white p-30 mb-40">
                                            ...
                                            <div class="author-info">
                                                <h3><span class="vcard author"><span class="fn"><a href="/" title="Posts by Robert" rel="author">ProPress</a></span></span></h3>
                                ...
                                @foreach($relateds as $rela)
                                    <article class="col-lg-4"><div class="background-white border-radius-10 p-10 mb-30">
                                            <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                                                @if(\Illuminate\Support\Facades\Auth::user())
                                                    <div class="imghover"><a href="/control/editnews/{{$rela['id']}}">Düzəliş et</a></div>
                                                @endif
                                                <a href="/{{Illuminate\Support\Str::slug($rela['cat_name'])}}/{{$rela['slug']}}">
                                                    <picture>
                                                        ...
                                                        <img src="{{asset('/news/images/'.$rela['image'])}}.webp" alt="{{$rela['title']}}">
                                                    </picture>
                                                </a>
                                            </div>
                ...
                <div class="row">
                    <div class="col-12 text-center mb-50">
                        <a href="#">
                            <img class="border-radius-10 d-inline" src="{{asset('site/images/imgs-ads-3.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="row mb-50">
...
@push('Js')
    ...
    <script>
        jQuery(function(){
            jQuery("#includedContent").load("https://jsonb.ru/banner.php");
        });
    </script>
    <script>
        $('.venobox').venobox({
