    ...
    <div class="sidebar-widget mb-50">
        ...
        <div class="post-aside-style-3">
            ...
            <article class="bg-white border-radius-15 mb-30 p-10 wow fadeIn animated">
                <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                    <a href="single.html">
                        <img class="border-radius-15" src="images/imgs-news-22.jpg" alt="">
                    </a>
                </div>
                <div class="pl-10 pr-10">
            ...
            <article class="bg-white border-radius-15 mb-30 p-10 wow fadeIn animated">
                <div class="post-thumb d-flex mb-15 border-radius-15 img-hover-scale">
                    <a href="single.html">
                        <img class="border-radius-15" src="images/imgs-news-20.jpg" alt="">
                    </a>
                </div>
                <div class="pl-10 pr-10">
        ...
        <div class="post-block-list post-module-6">
            <div class="last-comment mb-20 d-flex wow fadeIn animated">
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Azumi - 985 posts">
                                                    <img src="images/authors-author-14.png" alt=""></a>
                                            </span>
            ...
            <div class="last-comment mb-20 d-flex wow fadeIn animated">
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Harry - 1245 posts">
                                                    <img src="images/authors-author-9.png" alt=""></a>
                                            </span>
                <div class="alith_post_title_small">
            ...
            <div class="last-comment d-flex wow fadeIn animated">
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Johny - 445 posts">
                                                    <img src="images/authors-author-3.png" alt=""></a>
                                            </span>
                <div class="alith_post_title_small">
