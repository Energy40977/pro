        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <?php $demo_id = Illuminate\Support\Str::random(6); ?>
                            <div class="wizard-container">
                                <div class="card card-wizard" data-color="rose" id="wizardProfile">
                                    <form method="post" action="#" id="news" name="news" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-lg-10 mt-3">
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    <label for="editor2"></label><textarea  id="editor2" cols="80" rows="50"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-10 mt-3">
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    <label for="editor"></label><textarea  id="editor" cols="80" rows="50"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput" style="width:100%">
                                                                <div class="fileinput-new thumbnail">
                                                                    <img src="{{asset('/system/assets/img/image_placeholder.jpg')}}"  alt="...">
                                                                </div>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group mt-3">
                                                                    ...
                                                                    <select class="selectpicker form-control" name="category" data-size="10" data-style="btn btn-primary" id="kats" title="Kateqoriya" >
                                                        ...
                                                        <div class="col-lg-12 mt-12">
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    ...
                                                                    <input type="text" class="tagsinput" id="tags" name="tags" placeholder="Daxil edin"  data-role="tagsinput" data-color="primary">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mt-10">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="time" name="time" value="{{\Carbon\Carbon::now()}}" class="form-control datetimepicker" >
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="form-check" style="position: relative; top:25px;">
                                        <label class="form-check-label" onclick="secildi()">
                                            <input class="form-check-input" id="logosecc" type="checkbox" value=""> Galereya əlavə et
                                            <span class="form-check-sign">
                                                                  <span class="check"></span>
                                                                </span>
                                        </label>
                                    </div>
                                    <div class="logovur mt-50" id="logovur" style="display:none; position:relative;top:25px">
                                        ...
                                        <div class="card" id="galereya" style="display:none;">
                                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <div class="ml-auto">
                                    ...
                                    <button type="submit" id="draft" class="btn btn-fill btn-black ml-auto mr-auto" ><img src="{{asset('/system/assets/img/ss.gif')}}" id="bdd" style="display:none;" alt="" width="16px"><span id="bbd">Qaralama</span><div class="ripple-container"><div class="ripple-decorator ripple-on ripple-out" style="left: 72.6563px; top: 28px; background-color: rgb(255, 255, 255); transform: scale(14.6621);"></div></div></button>
    ...
    <script>
        function Deletegal(id){
            ...
            $.ajax({
                method:'post',
                url: '{{Route('delgal')}}',
                data: {_token: '{{@csrf_token()}}', data: '{{$demo_id}}', id:pid},
        ...
        $("#draft").click(function(){
            ...
            $.ajax({
                ...
                success:function(){
                    ...
                    window.location.href = "/control/drafts";
