                            ...
                            <div class="wizard-container">
                                <div class="card card-wizard" data-color="rose" id="wizardProfile">
                                    <form method="post" action="#" id="news" name="news" enctype="multipart/form-data" target="newStuff">
                                        ...
                                        <input type="hidden" name="edit" value="{{$drafts['id']}}">
                                                        ...
                                                        <div class="col-lg-10 mt-3">
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    <label for="editor2"></label><textarea  id="editor2" cols="80" rows="50">{{$drafts['title']}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-10 mt-3">
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    <label for="editor"></label><textarea  id="editor" cols="80" rows="50">{{$drafts['content']}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput" style="width:100%">
                                                                <div class="fileinput-new thumbnail">
                                                                    <img src="{{asset('news/images/'.$drafts['image'])}}"  alt="...">
                                                                </div>
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group mt-3">
                                                                    ...
                                                                    <select class="selectpicker form-control" name="category" data-size="15" data-style="btn btn-primary" id="kats" title="Kateqoriya" tabindex="-98">
                                                                        ...
                                                                        @foreach($cats as $cat)
                                                                            <option value="{{$cat['id']}}" <?php if($cat['id'] == $drafts['cat_id']){echo 'selected';} ?>>{{$cat['cat_name']}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group mt-50">
                                                                    ...
                                                                    <select class="selectpicker" data-style="select-with-transition" id="elavekat" name="elavekat[]" multiple title="Əlavə Kateqoriyalar" data-size="7" >
                                                                        ...
                                                                        <?php $cats = \App\Models\Category::all(); ?>
                                                                        <?php $bcat = explode(',', $drafts['cat_id']); unset($bcat[0]) ?>
                                                        ...
                                                        <div class="col-lg-12 mt-12">
                                                            <div class="input-group form-control-lg">
                                                                <div class="form-group bmd-form-group">
                                                                    ...
                                                                    <input type="text" class="tagsinput" id="tags" name="tags" placeholder="Daxil edin" value="{{$drafts['tags']}}" data-role="tagsinput" data-color="primary">
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="logovur mt-50" id="logovur" style=" position:relative;top:25px">
                                        <form action="{{ route('images.upload') }}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="demo_id" value="{{$demo_id}}">
                                            <input type="hidden" name="draft_id" value="{{$drafts['id']}}">
                                            <div class="row">
                                                <div class="col-sm-10">
