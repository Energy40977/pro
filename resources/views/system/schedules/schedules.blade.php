                                                ...
                                                @foreach($news as $new)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a href="/control/editschedule/{{$new['id']}}" id="{{$new['id']}}" class="btn btn-link btn-warning btn-just-icon edit"><i class="material-icons">dvr</i></a>
