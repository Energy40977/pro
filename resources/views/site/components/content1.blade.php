<div class="col-lg-8 col-md-12">
                    ...
                    <div class="pr-10 pl-10">
                        ...
                        <div class="mb-20 overflow-hidden">
                            ...
                            <div class="float-right">
                                <a href="/{{Illuminate\Support\Str::slug($slide['cat_name'])}}/{{$slide['slug']}}" class="read-more"><span class="mr-10"><i class="fa fa-thumbtack" aria-hidden="true"></i></span>Redaktorun seçimi</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-12 text-center mt-50 mb-50">
            <a href="#">
                <img class="border-radius-10 d-inline" src="{{asset('site/images/imgs-ads-3.jpg')}}" alt="post-slider">
            </a>
        </div>
    </div>
</div>
