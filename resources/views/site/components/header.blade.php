                            ...
                            <ul class="mobi-menu d-none menu-3-columns" id="navigation">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu text-muted font-small">
                                        ...
                                        <li><a href="/yerli">Yerlİ</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="/siyaset">Siyasət</a>
                                    <ul class="sub-menu text-muted font-small">
                                        <li><a href="/xarici-siyaset">Xarİcİ sİyasət</a></li>
                                        <li><a href="/azerbaycan">Azərbaycan</a></li>
                                    </ul>
                                </li>
                                <li class="cat-item cat-item-4"><a href="/kriminal">Krİmİnal</a></li>
                                <li class="cat-item cat-item-5"><a href="/iqtisadi">İqtİsadİ</a></li>
                                <li class="cat-item cat-item-6"><a href="/sehiyye">Səhİyyə</a></li>
                                <li class="menu-item-has-children">
                                    <a href="/medeniyyet ">Mədəniyyət</a>
                                    <ul class="sub-menu text-muted font-small">
                                        <li><a href="/tehsil">Təhsİl</a></li>
                                        <li><a href="/turizm">Turİzm</a></li>
                                        <li><a href="/metbex">Mətbəx</a></li>
                                        <li><a href="/sou-biznes">Şou-Bİznes</a></li>
                                    </ul>
                                </li>
                                <li class="cat-item cat-item-2"><a href="/texnologiya">Texnologİya</a></li>
